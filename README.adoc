...
Works with SoftDevice S110 v8.x with Timeslot API (tested), likely to work with
S120 and S130 SoftDevices (not tested). Support for both SDK6.x.x and SDK7.x.x as of release v0.6.1, as well as SDK8.x.x as of release v0.6.5.
