...
app_serial_LED1.hex file to the device you want to connect to via serial. When finished, your device should be
...
*WARNING:* _For this step, it is important that you close any running instance of nRFgo Studio,
as it has been known to trip up the reset procedure for the nRF51._
