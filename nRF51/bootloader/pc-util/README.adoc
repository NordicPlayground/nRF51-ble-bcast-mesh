...
== Build/run
The GNU Makefile in this repository can be used to build the tool with GCC (works on UNIX with any
version of GCC 4.0 and above, and on Windows platforms with MinGW, and Cygwin). The application
